...
if(isset($_SESSION['new_message_received']) && $_SESSION['new_message_received'] == true) {
    echo '<script>alert("A new message has been received!");</script>';

    // Reset the session variable to prevent the alert from showing again
    unset($_SESSION['new_message_received']);
}
?>
<html lang="en">
  <head>
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Pulse Care </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-mes" id="list-mes-list"  role="tab" data-toggle="list" aria-controls="home">Emergency Massage🚨</a>
